...
module.exports = {
	...
	execute: async ({ client, interaction }) => {
        ...
        if (queue.node.isPaused()) return interaction.reply({ embeds: [new EmbedBuilder().setDescription(`<:DispifyError:1033721529084694598> You already stop the queue.`).setColor(`Red`)] })
